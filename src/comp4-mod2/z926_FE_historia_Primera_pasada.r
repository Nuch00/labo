...
PARAM  <- list()
PARAM$experimento <- "FINAL_V3_FE9000"

PARAM$exp_input  <- "FINAL_V3_DR9000"
...
variables_buenas = c('ctrx_quarter_normalizado','ctrx_quarter',
                     ...
                     'ccomisiones_mantenimiento_delta6','mcomisiones_mantenimiento_rank_delta6','cliente_edad','cliente_antiguedad')
# 
