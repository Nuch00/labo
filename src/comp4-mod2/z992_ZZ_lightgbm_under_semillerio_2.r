...
PARAM <- list()
PARAM$experimento <- "ZZ9000_semillerio_ensamble_m1"
PARAM$exp_input <- "FINAL_V2_HT9000"

# PARAM$modelos  <- 2
PARAM$modelo <- 1 # se usa el mejor de la OB, pero a futuro podria variar esto
PARAM$semilla_primos <- 191911
PARAM$semillerio <- 100 # ¿De cuanto será nuestro semillerio?
PARAM$indice_inicio_semilla <- 34
PARAM$indice_fin_semilla <- 66
