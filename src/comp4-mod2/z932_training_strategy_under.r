...
PARAM  <- list()
PARAM$experimento <- "FINAL_V3_TS9000"

PARAM$exp_input  <- "FINAL_V3_FE9000_2da"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 
                         202011, 202012, 202101, 202102, 202103, 202104, 202105, 202106 )

PARAM$train$training     <- c( 201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 
                               201910, 201911, 201912, 202001, 202002,202011, 202012, 202101, 202102, 
...
PARAM$train$semilla_sampling  <- 690143
PARAM$train$semilla_under     <- 690143
