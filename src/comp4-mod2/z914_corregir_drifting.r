...
PARAM  <- list()
PARAM$experimento  <- "FINAL_V3_DR9000"

PARAM$exp_input  <- "FINAL_V3_CA9000"
...
AgregarVariables  <- function( dataset )
{
  ...
  for(i in 1:length(meses)){
    eval(parse(text=paste0("dataset$periodo_",meses[i],'= ifelse(dataset$foto_mes==',meses[i],',1,0)')))
...
drift_deflacion  <- function( campos_monetarios )
{
  ...
  vIPC  <- c( 1.9903030878, 1.9174403544, 1.8296186587,
              ...
              0.7763107219  )
  vIPC  <- c( 4.976618544,4.647724674,4.369037232,
              4.149621204,3.935159343,3.696740974,
              3.500138191,3.348797938,3.231001451,
              3.131758476,3.039367312,2.938216627,
              2.851088714,2.776113627,2.692727249,
              2.606643962,2.515287621,2.40657934,
              2.310933259,2.221952569,2.140841474,
              2.066207341,1.995330011,1.932470789,
              1.879912871,1.838218994,1.801379854,
              1.768049414,1.742338958,1.701160047,
              1.657805745,1.621760639,1.576102022,
              1.515630045,1.459170304,1.396398551,
              1.329361792,1.289892473,1.25914871,
              1.223139103,1.18527862,1.138551391,
              1.092802974,1.055676491,1.028898857,
              1)
