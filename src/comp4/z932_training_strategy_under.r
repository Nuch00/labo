...
PARAM  <- list()
PARAM$experimento <- "FINAL_V2_TS9000"

PARAM$exp_input  <- "FINAL_V2_FE9000_2da"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201901,201902,201903,201904,201905,201906,201907,201910,201911,201912,202001,
                         202002,202003,202011,202012,202101,202102,202103,202104,202105,202106,202107)

PARAM$train$training     <- c( 201901,201902,201903,201904,201905,201906,201907,201908,201909,201910,201911,201912,202001,
                               202002,202003,202011,202012,202101,202102,202103,202104,202105,202106,202107 )
PARAM$train$validation   <- c( 201908 )
PARAM$train$testing      <- c( 201909 )
...
PARAM$train$undersampling_mayoritaria  <- 1   # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA

#Atencion, las semillas deben ser distintas
PARAM$train$semilla_sampling  <- 191911
PARAM$train$semilla_under     <- 191911
