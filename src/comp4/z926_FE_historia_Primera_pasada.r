...
PARAM  <- list()
PARAM$experimento <- "FINAL_V1_FE9000"

PARAM$exp_input  <- "FINAL_V1_DR900"
...
variables_buenas = c('ctrx_quarter_normalizado','ctrx_quarter',
'mcuentas_saldo_rank','mpayroll_sobre_edad_rank',
'cpayroll_trx','ctrx_quarter_lag1',
'mcaja_ahorro_rank','mprestamos_personales_rank',
'mpasivos_margen_rank','mpayroll_rank',
'mtarjeta_visa_consumo_rank','ctrx_quarter_normalizado_lag1',
'ccomisiones_mantenimiento_delta6','mcomisiones_mantenimiento_rank_delta6')
...
for(i in 1:length(combinaciones)){
  ...
  if(i == 20) CanaritosAsesinos( canaritos_ratio = 0.3 )
