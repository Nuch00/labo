...
PARAM  <- list()
PARAM$experimento <- "FINAL_V4_TS9000"

PARAM$exp_input  <- "FINAL_V4_FE9000"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201908, 201909, 201910,  202008, 202009, 202101, 202102, 202103, 202104, 202105, 202106, 202103, 202104 )

PARAM$train$training     <- c( 201906, 201907, 201908, 201909, 201910, 202008, 202009, 202101, 202102, 202103, 202104
 )
